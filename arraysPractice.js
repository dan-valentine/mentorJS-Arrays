...
//it's only argument and removes all values that aren't even from the given array.

  //Code Here
  function evenFinder(n){
    return n.filter(e=>!(e%2))
  }
...
//(that will be passed in as a parameter) to see if that random number is in the array. 
//If it is, return true, if it's not, return false

  //Code Here
  function finder(a){
    return a.indexOf(getRandomArbitrary()) !== -1
  }
...
function removeItem(a, i){
  return a.splice(a.indexOf(i), 1), a;
}
...
Loop through your devMountainEmployees until you find cahlan, then remove him from the array.*/
  ...
  devMountainEmployees.splice(devMountainEmployees.findIndex(e=>e.name === 'Cahlan'), 1)
...
Once you find the particular index he's located in, delete him from the array.*/
  ...
  //Code Here
  users.splice(users.findIndex(u=>u.email === 'tylermcginnis33@gmail.com'), 1)
